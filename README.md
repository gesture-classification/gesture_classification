...
Задача замещения функции утраченного органа была актуальной во все времена. В настоящее время технический прогресс дошел до такой степени, что некоторые части и функции организма могут быть практически полностью заменены на аппаратные (искусственная почка, аппарат ИВЛ, клапаны сердца и т. п.). Однако, не смотря на всю технологическую сложность, некоторые аппараты нуждаются в существенной доработке для того, чтобы приблизиться к функционалу замещаемого органа. 
Одной из наиболее сложных проблем является протезирование кистей рук ввиду сложной анатомии и высокой функциональной вариабельности. 
Не смотря на то, что по [данным](https://rosstat.gov.ru/storage/mediabank/ST90u1EJ/2-30.doc) РосСтата на 2020г количество больных, нуждающихся в протезировании кисти, составляется порядка 2600 человек (около 1.5% от всех нуждающихся в протезировании), развитие и совершенствование данных аппаратов не вызывает сомнения ввиду значительного влияния на качество жизни.
Для улучшения функционала бионических кистевых протезов компанией ["Моторика"](https://motorica.org/) была предложена [задача](https://www.kaggle.com/competitions/motorica-advanced-gesture-classification/leaderboard) «распознавания жестов» на основании данных оптомиографических датчиков.
В ходе соревнования на Kaggle нами была создана математическая модель, предсказывающая жест человека по сокращению мышц кисти. Модель может использоваться для управления автоматизированным протезом кисти. Задача исследования заключалась в следующем:
...
Для лучшего понимания исходных данных и для выстраивания более оптимальной тактики решения поставленной задачи стоит углубиться в физику процесса.  
...
Сбор данных был организован следующим образом: случайным образом было выбрано 3 человека-оператора со здоровыми руками, чтобы обеспечить достоверность показаний. Затем к коже их рук были прикреплены оптомиографические датчики.Когда рука находится в состоянии покоя, изменений отражающей способности кожи не регистрируется, поэтому на выходе фототранзистора регистрируется постоянное значение напряжения. При возникновении движения происходит изменение параметров среды для прохождения светового пучка, следовательно изменяется количество света, попадающего на детектор. Важно понимать, что чем сильнее было изменение среды (а наиболее вероятно это связано именно с мышечным сокращением), тем больше будет разница первоначальных и конечных показаний датчиков. 
