...
- загрузка тестовых данных с помощью класса *DataReader*; 
...
1. загрузите исходные данные в папку *data*  в формате `*.npy` или `*.pkl`. Каждый временной ряд должен иметь 50 признаков-показаний датчиков ОМГ одинаково произвольной длительности.
